<template>
  <form @submit.prevent>
    <h2>Обновить/Удалить контакт</h2>
    <my-input class="input__create" placeholder="Имя" v-model="task.name" />
    <my-input class="input__create" placeholder="Номер" v-model="task.phone"/>
