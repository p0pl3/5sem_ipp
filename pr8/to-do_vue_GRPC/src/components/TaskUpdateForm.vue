...
<!--    <my-textarea placeholder="Description" v-model="task.description"/>-->
    <my-button class="btn__create" @click="updateTask">Изменить</my-button>
    <my-button class="btn__delete" @click="deleteTask">Удалить</my-button>
  </form>
</template>
